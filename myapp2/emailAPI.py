def sendMail(email,password):
    ...
    me = "rajputrajendra778@gmail.com"
    you = email

    msg = MIMEMultipart('alternative')
    msg['Subject'] = "Verification Mail LeatherWorld.com"
    msg['From'] = me
    msg['To'] = you
    ...
    html = """<html>
  					<head></head>
  					<body>
    					<h1>Welcome to LeatherWorld.com</h1>
    ...
    s.starttls() 
    s.login("rajputrajendra778@gmail.com", "vurz rkil rdlc kpii") 
